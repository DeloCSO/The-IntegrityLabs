        ...
        <div className="max-w-4xl mx-auto px-6 md:px-8 lg:px-12 py-12 md:py-16">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              >
                The Student Conversation Space at The IntegrityLabs
              </p>
            </section>
            ...
            {/* 6. CTAs */}
            <div className="pt-6 mt-4 space-y-4" style={{ borderTop: '1px solid var(--border-color)' }}>
              <button
              ...
              >
                Ready for deeper work? Explore Forge
                <ArrowRight size={18} />
              </Link>
            </div>
          </div>
